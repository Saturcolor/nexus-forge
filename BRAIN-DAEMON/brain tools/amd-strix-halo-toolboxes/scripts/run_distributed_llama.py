...
# Default RPC Hosts — override via --hosts or RPC_HOSTS env var
# Example: ("192.168.1.11", True), ("192.168.1.12", True)
DEFAULT_HOSTS: list[tuple[str, bool]] = [
    # ("192.168.1.11", True),   # add your RPC nodes here
]
